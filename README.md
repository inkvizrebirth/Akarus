...
[![Version](https://img.shields.io/badge/version-1.1.0-7C6CFF)](https://github.com/inkvizrebirth/Dreamcast/releases)
...
2. Скачай `dreamcast-1.1.0.jar` из [Releases](https://github.com/inkvizrebirth/Dreamcast/releases) и положи в `.minecraft/mods`.
