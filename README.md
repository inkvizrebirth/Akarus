...
[![Version](https://img.shields.io/badge/version-1.1.1-7C6CFF)](https://github.com/inkvizrebirth/Dreamcast/releases)
...
2. Скачай `dreamcast-1.1.1.jar` из [Releases](https://github.com/inkvizrebirth/Dreamcast/releases) и положи в `.minecraft/mods`.
